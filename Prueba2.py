...
# Lee el audio del stream en bloques de tamaño CHUNK y los guarda en una lista de frames
...
class Mygame(arcade.Window):
  def __init__(self):
    ...
    cosa = Process(target=convertData)
    cosa.start()
